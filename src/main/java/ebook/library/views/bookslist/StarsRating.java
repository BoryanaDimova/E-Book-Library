...
public class StarsRating extends AbstractSinglePropertyField<StarsRating, Integer> {
     ...
     * Creates a Star-Rating Component
     * 
     * @param rating manual rating in stars
     */
     ...
     * @param rating   manual rating in stars
     * @param numstars max amount of stars
     * @param manual   In manual mode the user is able to change the rating
     */
    ...
    /**
     * Checks it the Component is in manual mode. (In manual mode the user is able
     * to change the rating)
     * 
     * @return if the component is in manual mode
     */
    ...
    /**
     * Sets the manual mode. If set to <code>true</code> the user is able to change
     * the rating
     * 
